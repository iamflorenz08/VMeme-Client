    ...
    return (
        <main className="flex flex-col container mx-auto xl:px-20 mb-20 duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h2 className="text-2xl font-bold mb-4">Flourish</h2>
                    <hr className="mb-4" />
                    <p className="mb-4">
                        Abueva-Fernando, Naomi Banal, Flor Baradi, Sue Bernardo-Montelibano, Remy Boquiren, Chie Cruz, Addie Cukingnan, Lisa De Leon-Zayco,
                        Joey Dyhianto, Eileen Bondoc Escueta, Julia Lopue, Inka Madera, Jinky Rayo, Maria Ann Reyes, Alicia Santos, Sheila Tiangco, Jo Uygongco, Melissa Villasenor
                        and Inna Naanep-Vitasa
                    </p>
                    <hr className="mb-4" />
                    <hr className="mb-4" />
                ...
                {[1, 2, 3, 4].map((value, index) => (
                    <div
                        ...
                        <div className='flex flex-col w-fit px-5'>
                            <Image className='h-[380px] object-cover object-top' src={'/amara.png'} alt='amara' width={1000} height={1000} />
